...
class ManageBookingRegistered extends Component {

    state = {
        allBooking : [],
        editBooking : [],
        loading : false,
        editBookingType : 'registered'
    }
...
export default connect(mapStateToProps, { getAllBooking, updateBookingStatus, deleteBooking })(ManageBookingRegistered)
